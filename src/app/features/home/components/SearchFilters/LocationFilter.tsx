...
import { useGetUbicacionesQuery } from "../../store/homeApi"
...
export const LocationFilter = ({
  ...
  const { data: locations = [] } = useGetUbicacionesQuery()
      ...
      >
        <div className="grid max-h-64 grid-cols-1 gap-1 overflow-y-auto pr-1">
          {locations.length > 0 ? (
            ...
            <p className="p-4 text-center text-xs text-slate-400">No hay ubicaciones disponibles</p>
          )}
        </div>
      </PopoverContent>
    </Popover>
